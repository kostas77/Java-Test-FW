...
@Slf4j
public class myAccountFRSteps extends BasePage {
    ...
    @Then("I edit the profile information in FR-HS")
    public void i_edit_the_profile_information(DataTable table) {
        ...
        Assertions.assertEquals("Votre compte a bien été mis à jour.", myAccountActions.txtSuccessMessage.GetTextValue());
    }
    ...
    public void i_edit_the_default_billing_address(DataTable table) {
        ...
        DriverContext.waitForPageToLoad();
        DriverContext.waitUntilElementIsVisible(myAccountActions.txtSuccessMessage);
        Assertions.assertEquals("Vous avez enregistré l'adresse.", myAccountActions.txtSuccessMessage.GetTextValue());
    }
    ...
    public void i_delete_the_newly_added_address() {
        ...
        DriverContext.waitForPageToLoad();
        DriverContext.waitUntilElementIsVisible(myAccountActions.txtSuccessMessage);
        Assertions.assertEquals("Vous avez supprimé l'adresse.", myAccountActions.txtSuccessMessage.GetTextValue());
    }
    ...
    public void i_add_the_product_to_cart_from_wishlist() {
        ...
        DriverContext.waitUntilElementIsVisible(myAccountActions.txtSuccessMessage);
        Assertions.assertTrue(myAccountActions.txtSuccessMessage.GetTextValue().contains("Vous avez ajouté"));
    ...
    public void i_remove_the_product_from_wishlist() {
        ...
        DriverContext.waitUntilElementIsVisible(myAccountActions.txtSuccessMessage);
        Assertions.assertTrue(myAccountActions.txtSuccessMessage.GetTextValue().contains("a été retiré de votre liste d'achats."));
    }
}
