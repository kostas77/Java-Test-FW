...
public class MyAccountLocators extends BasePage {

    //Profile Inforamtion
    @FindBy(how = How.XPATH, using = ".//a[contains(@href,'profile/edit')]")
    public Button btnProfileEdit;

    public By drpdwnTitle = By.cssSelector("select#prefix");

    public By drpdwnProfession = By.cssSelector("select#profession");

    public By drpdwnSpeciality = By.cssSelector("select#speciality");

    @FindBy(how = How.CSS, using = "button#submit_save")
    public Button btnSaveProfileInformation;

    @FindBy(how = How.ID, using = "is_terms")
    public CheckBox chkboxAcceptTNC;

    //AddressBook locators
    @FindBy(how = How.XPATH, using = "(.//a[contains(@href,'customer/address')])[4]")
    ...
    public By drpdwnAddressTitle = By.cssSelector("select#prefix");
    ...
    //Wishlist Locators
    @FindBy(how = How.XPATH, using = "(.//a[contains(@href,'wishlist')])[2]")
    ...
    @FindBy(how = How.XPATH, using = "(.//a[contains(@href,'order/history')])[2]")
    public Button btnMyOrder;

    @FindBy(how = How.CSS, using = ".action.order")
