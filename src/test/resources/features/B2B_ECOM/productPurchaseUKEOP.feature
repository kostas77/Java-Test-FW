Feature: Product purchase E2E tests for UK EOP B2B health store
  As a customer
  I want to be able to purchase different product types (ebook, ejournal,...)

  @UKB2BEOPStore @UKEOP_E2E @B2BE2E
  Scenario: eBook purchase using the existing account checkout path
    ...
    Then The B2B order is validated with ORR API request "UK EOP"
